...
function Team({ schoolName }) {
  return (
    <TiltedCard> 
      <div className="border-2 rounded-[1rem] h-44 w-32 md:h-60 md:w-40 flex flex-col items-center justify-center p-2 overflow-hidden shadow-md bg-white/10 backdrop-blur-sm">
